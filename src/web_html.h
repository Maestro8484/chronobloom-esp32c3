...
static const char INDEX_P2[] PROGMEM =
  ...
  "</div>\n"
  "<div class='row'>\n"
  "  <div><label>Preview animation</label><select id='stylePreviewType'>\n"
  "    <option value='quarter:5'>Quarter - DNA twist (2s)</option>\n"
  "    <option value='quarter:4'>Quarter - Laser ping (1.4s)</option>\n"
  "    <option value='quarter:6'>Quarter - Tick spark (0.8s)</option>\n"
  "    <option value='halfhour:4'>Half-hour - Multi-chase (4s)</option>\n"
  "    <option value='halfhour:6'>Half-hour - Knight Rider (5s)</option>\n"
  "    <option value='halfhour:5'>Half-hour - Ripple burst (3.5s)</option>\n"
  "    <option value='halfhour:7'>Half-hour - Strobe party (3s)</option>\n"
  "    <option value='hour:7'>Hour - Firefly swarm (8s)</option>\n"
  "    <option value='hour:9'>Hour - Color wipe (10s)</option>\n"
  "    <option value='reminder:6'>Reminder - Amber pulse</option>\n"
  "    <option value='reminder:7'>Reminder - Red alert</option>\n"
  "  </select></div>\n"
